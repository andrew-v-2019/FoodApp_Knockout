...
const routes: Route[] = [
    ...
    { url: 'menu', params: { page: 'edit-menu' } },
    { url: 'lunch', params: { page: 'edit-lunch' } },
    { url: 'order', params: { page: 'order' } }
];
...
class AppRootViewModel {
    ...
    constructor(params: { history: History.History }) {
        ...
        ko.components.register('edit-menu', require('bundle-loader?lazy!../edit-menu/edit-menu'));
        ko.components.register('edit-lunch', require('bundle-loader?lazy!../edit-lunch/edit-lunch'));
        ko.components.register('order', require('bundle-loader?lazy!../order/order'));
    }
